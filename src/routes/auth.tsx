...
export const Route = createFileRoute("/auth")({
  ssr: false,
  head: () => ({ meta: [{ title: "Sign in · WeboGrowth Planner" }] }),
  component: AuthPage,
});
          ...
          <Tabs defaultValue="login">
            ...
            <TabsContent value="login" className="mt-4 space-y-4">
              <form onSubmit={onLogin} className="space-y-3">
                ...
                <Button type="submit" disabled={busy} className="w-full gradient-primary text-white">Log in</Button>
              </form>
            </TabsContent>
            ...
            <TabsContent value="signup" className="mt-4 space-y-4">
              <form onSubmit={onSignup} className="space-y-3">
                ...
                <Button type="submit" disabled={busy} className="w-full gradient-primary text-white">Create account</Button>
              </form>
            </TabsContent>
          </Tabs>
